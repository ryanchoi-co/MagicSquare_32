...
| AC-FR-01-01 GREEN (Boundary) | 🔄 **25 / 33 passed** — BV-01~03 구현 |
...
# 25 passed, 8 failed  (BV-04a~04b 대기)
```
...
1. **G-04 GREEN:** 3×4 → `INVALID_SIZE` (커밋 1건)  
2. **G-05 GREEN:** 4×3 → AC-FR-01-01 **33 passed**  
